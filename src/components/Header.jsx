          ...
          {isMenu && (
            ...
            >
              ...
              <p
                ...
                className="m-2 p-2 rounded-md shadow-md flex items-center gap-3 cursor-pointer hover:bg-gray-300 transition-all justify-center bg-gray-200 duration-100 ease-in-out text-textColor text-base"
              >
                Login <BiLogIn />
              </p>
            </motion.div>
